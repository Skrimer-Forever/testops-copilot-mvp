...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        // ЗАМЕНА: bg-slate-950 -> bg-black
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black w-full rounded-md z-0",
        className
      )}
    >
      <div className="absolute top-0 z-0 flex w-full h-screen scale-y-125 items-center justify-center isolate -translate-y-[17rem]">
        <motion.div
        ...
        >
          {/* ЗАМЕНА: bg-slate-950 -> bg-black (маски градиентов) */}
        ...
        {/* ЗАМЕНА: bg-slate-950 -> bg-black (центральный блюр) */}
        ...
        {/* ЗАМЕНА: bg-slate-950 -> bg-black (нижняя перекрывающая маска) */}
