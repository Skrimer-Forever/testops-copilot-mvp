...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$chat$2d$sidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/chat-sidebar.tsx [app-ssr] (ecmascript)"); // Импорт нового компонента
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chevron$2d$down$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__ChevronDown$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/chevron-down.js [app-ssr] (ecmascript) <export default as ChevronDown>"); // PanelLeft иконка меню
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$panel$2d$left$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__PanelLeft$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/panel-left.js [app-ssr] (ecmascript) <export default as PanelLeft>");
"use client";
;
;
...
function Home() {
    ...
    const [chatHistory, setChatHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([
        {
            id: "1",
            title: "Генерация тестов для Auth"
        },
        {
            id: "2",
            title: "Анализ HTML формы"
        },
        {
            id: "3",
            title: "Сценарий: Корзина"
        },
        {
            id: "4",
            title: "Чат 4"
    ...
    const handleNewChat = ()=>{
        ...
        setIsThinking(false);
    // Закрываем сайдбар на мобилках (опционально)
    };
    const handleSelectChat = (id)=>{
        // Здесь в будущем будет загрузка сообщений с бэкенда
        setActiveChatId(id);
        setIsChatStarted(true); // Сразу открываем интерфейс чата
        setMessages([
            // Фейковая подгрузка истории
            {
                id: "old1",
                role: "user",
                content: `Загружена история чата ${id}`
            },
            {
                id: "old2",
                role: "assistant",
                content: "История восстановлена."
            }
        ]);
    };
    // --- ЛОГИКА ЧАТА ---
    ...
    const handleSendMessage = (content, files)=>{
        ...
        setIsThinking(true);
        // Если это первый месседж в сессии - создаем "новый чат" в истории
        if (!activeChatId) {
        ...
        setTimeout(()=>{
            ...
            if (isCodeRequest) {
                aiContent = "Конечно! Вот код кнопки. Панель справа открыта.";
                setCurrentCode(`import React from "react";
import { cn } from "@/lib/utils";

export const Button = ({ className, ...props }) => {
  return (
    <button className={cn("px-4 py-2 bg-blue-500 rounded", className)} {...props} />
  );
};`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__165e1d85._.js.map