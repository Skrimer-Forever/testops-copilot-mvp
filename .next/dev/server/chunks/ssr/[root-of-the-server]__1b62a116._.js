...
function Home() {
    ...
    const handleSendMessage = (content, files)=>{
        ...
        setIsThinking(true);
        const isCodeRequest = content.toLowerCase().includes("хуй") || content.toLowerCase().includes("мать шлюха");
        setTimeout(()=>{
            setIsThinking(false);
            let aiContent = "Это обычный ответ. Если хочешь увидеть код, напиши слово 'хуй'.";
            if (isCodeRequest) {
                aiContent = "Конечно! Вот код кнопки, который вы просили. Панель справа открыта.";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1b62a116._.js.map